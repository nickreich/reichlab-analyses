...
# outbreak dataset (Zheng et al. 2026, Gates Open Research 10:16;
# OSF https://osf.io/2ncf7/). One page per location, written to
# cholera/plots/outbreak_by_location.pdf. Discrete outbreak episodes within a
# location are colored by outbreak_UID so separate epidemics are distinct.
#
# By default we plot country-level series (spatial_scale == "country"). Set
# SCALE_FILTER to NULL to generate a page for every location (~280 pages).
#
# Usage (from repo root):
#   Rscript cholera/plot_outbreak.R
#
...
IN_FILE  <- "cholera/data/Public_outbreak_dataset.csv"
OUT_FILE <- "cholera/plots/outbreak_by_location.pdf"
